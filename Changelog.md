## August 24, 2023
* GhostBSD errors out at boot running kern.securelevel="1" because of the default load of linux, linux64, fusefs
    * Removed directive
* Added directive `security.bsd.stack_guard_page=1` from developer comments
